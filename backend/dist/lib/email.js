...
class EmailService {
    ...
    getProductPublishedTemplate(data) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getCreatorWelcomeTemplate(data) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
