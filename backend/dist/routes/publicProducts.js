...
exports.publicProductsRouter = void 0;
...
exports.publicProductsRouter = (0, express_1.Router)();
/**
 * GET /api/products
 ...
 */
exports.publicProductsRouter.get("/", async (req, res) => {
    try {
 ...
 */
exports.publicProductsRouter.get("/:id", async (req, res) => {
    try {
        ...
        if (product.aiPromptPack?.prompts) {
            product.aiPromptPack = {
                ...product.aiPromptPack,
                prompts: product.aiPromptPack.prompts.map((p) => ({ label: p.label })),
            };
        }
 ...
 */
exports.publicProductsRouter.get("/:id/images", async (req, res) => {
    try {
        const slug = String(req.params.id || "").trim();
        ...
        const images = await ImageAsset_1.ImageAsset.find({ productId: product._id })
...
exports.publicProductsRouter.post("/analyse", async (req, res) => {
    try {
        const apiKey = process.env.GEMINI_API_KEY;
        if (!apiKey)
            return res.status(500).json({ ok: false, error: "Gemini API not configured" });
