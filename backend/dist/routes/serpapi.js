...
exports.serpApiRouter = void 0;
const express_1 = require("express");
exports.serpApiRouter = (0, express_1.Router)();
// Google Images Search using SerpApi
exports.serpApiRouter.post("/images", async (req, res) => {
    try {
...
exports.serpApiRouter.post("/search", async (req, res) => {
    try {
