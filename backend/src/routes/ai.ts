...
aiRouter.post("/buyer-analysis", async (req, res) => {
  try {
    const { 
      title, 
      description, 
...
aiRouter.post("/analyze-competitors", async (req: AuthedRequest, res) => {
  try {
...
aiRouter.post("/generate-seo", async (req: AuthedRequest, res) => {
  try {
...
aiRouter.post("/optimize-content", async (req: AuthedRequest, res) => {
  try {
...
aiRouter.post("/analyze-structure", async (req: AuthedRequest, res) => {
  try {
...
aiRouter.post("/pricing-intelligence", async (req: AuthedRequest, res) => {
  try {
...
// Trend Analysis
aiRouter.post("/analyze-trends", async (req: AuthedRequest, res) => {
  try {
...
aiRouter.post("/comprehensive-analysis", async (req: AuthedRequest, res) => {
  try {
    const { 
      title, 
      description, 
