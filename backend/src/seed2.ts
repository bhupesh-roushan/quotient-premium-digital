...
async function ensureSlug(base: string) {
  let slug = base;
  let i = 0;
...
const PRODUCT_TEMPLATES = [
  {
    ...
    deliverables: [
      { label: "Prompt Pack PDF Guide", url: SAMPLE_PDF, kind: "file" as const },
      { label: "View Notion Template", url: "https://notion.so/ai-prompts", kind: "link" as const },
    ],
...
module.exports = prompts;`,
    aiPromptPack: {
      ...
      downloadType: "structured" as const,
      prompts: [
  ...
  },
  {
    ...
    deliverables: [
      { label: "Setup Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Duplicate Notion Template", url: "https://notion.so/templates/life-os", kind: "link" as const },
    ],
...
module.exports = { getGoals };`,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Resume Template PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Figma Source File", url: "https://figma.com/resume-template", kind: "link" as const },
    ],
...
.experience-item { margin-bottom: 1.5rem; }`,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Component Documentation PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Storybook Preview", url: "https://storybook.js.org/glass-ui-kit", kind: "link" as const },
    ],
...
export const GlassButton = ({ children, onClick }) => (
  ...
  },
  {
    ...
    deliverables: [
      { label: "Icon Usage Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Figma Source File", url: "https://figma.com/icon-pack-1200", kind: "link" as const },
    ],
...
export const LayersIcon = (props) => <svg {...props}>{/* paths */}</svg>;`,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Productivity Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Notion Template", url: "https://notion.so/productivity-dashboard", kind: "link" as const },
    ],
...
module.exports = weeklyReview;`,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Setup Documentation PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "GitHub Repository", url: "https://github.com/example/nextjs-saas-boilerplate", kind: "link" as const },
    ],
    code: `// next.config.js
...
export const { handlers, auth, signIn, signOut } = NextAuth({
  ...
  providers: [],
    ...
    developerBoilerplate: {
      ...
      architecture: "fullstack" as const,
      includesAuth: true,
      includesDatabase: true,
      includesTesting: true,
      deploymentReady: true,
      documentation: true,
      starterType: "nextjs" as const,
    },
  },
  {
    ...
    deliverables: [
      { label: "Architecture Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "GitHub Repository", url: "https://github.com/example/mern-starter", kind: "link" as const },
    ],
...
app.listen(5000, () => console.log('Server on port 5000'));`,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Security Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "GitHub Repository", url: "https://github.com/example/jwt-auth-system", kind: "link" as const },
    ],
...
module.exports = { requireAuth };`,
    developerBoilerplate: {
      ...
      architecture: "mvc" as const,
      includesAuth: true,
      includesDatabase: true,
      includesTesting: true,
      deploymentReady: false,
      documentation: true,
      starterType: "express" as const,
    },
  },
  {
    ...
    deliverables: [
      { label: "Launch Checklist PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Live Demo", url: "https://saas-starter-demo.vercel.app", kind: "link" as const },
    ],
...
export async function handleWebhook(event: Stripe.Event) {
  ...
  },
  {
    ...
    deliverables: [
      { label: "API Design Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "GitHub Repository", url: "https://github.com/example/express-api-scaffold", kind: "link" as const },
    ],
...
export default router;`,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Setup Walkthrough PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Make.com Blueprint", url: "https://make.com/blueprints/client-onboarding", kind: "link" as const },
    ],
    code: `// Webhook trigger payload (Make.com compatible)
{
  ...
  "actions": [
    ...
    workflowSystem: {
      workflowType: "business" as const,
      stepsCount: 8,
      tools: ["Make.com", "Notion", "Gmail", "Calendly", "Airtable"],
      integrationLevel: "intermediate" as const,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Pipeline Setup Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Make.com Blueprint", url: "https://make.com/blueprints/social-media-pipeline", kind: "link" as const },
    ],
...
module.exports = pipeline;`,
    workflowSystem: {
      workflowType: "automation" as const,
      stepsCount: 12,
  ...
  },
  {
    ...
    deliverables: [
      { label: "System Overview PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Notion Template", url: "https://notion.so/ai-daily-planner", kind: "link" as const },
    ],
...
module.exports = { planDay };`,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Full Blueprint PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Resource Notion Page", url: "https://notion.so/freelance-blueprint", kind: "link" as const },
    ],
...
module.exports = proposal;`,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Masterclass PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Bonus Workflow Templates", url: "https://make.com/bonus-workflows", kind: "link" as const },
    ],
...
actions:
  ...
  },
  {
    ...
    deliverables: [
      { label: "GTD Reference Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Notion Template", url: "https://notion.so/gtd-second-brain", kind: "link" as const },
    ],
...
module.exports = { capture, clarify, inbox };`,
    productivityFramework: {
      frameworkType: "productivity" as const,
  ...
  },
  {
    ...
    deliverables: [
      { label: "Component Guide PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "Live Demo", url: "https://react-admin-demo.vercel.app", kind: "link" as const },
    ],
    code: `// Dashboard.tsx
...
export default function Dashboard() {
  ...
  },
  {
    ...
    deliverables: [
      { label: "Hooks API Reference PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "GitHub Repository", url: "https://github.com/example/typescript-hooks", kind: "link" as const },
    ],
...
export function useLocalStorage<T>(key: string, initial: T) {
  ...
  },
  {
    ...
    deliverables: [
      { label: "Animation Reference PDF", url: SAMPLE_PDF, kind: "file" as const },
      { label: "CodePen Preview", url: "https://codepen.io/css-animation-library", kind: "link" as const },
    ],
    code: `/* animations.css */
@keyframes fadeInUp {
...
async function seed() {
  ...
  for (let i = 1; i <= NUM_USERS; i++) {
    ...
    const passwordHash = await hashPassword(`user${i}`);
  ...
  for (const user of createdUsers) {
    ...
    for (let ti = 0; ti < PRODUCT_TEMPLATES.length; ti++) {
      ...
      if (tmpl.aiPromptPack) productData.aiPromptPack = tmpl.aiPromptPack;
      if ((tmpl as any).template) productData.template = (tmpl as any).template;
      if ((tmpl as any).codeTemplate) productData.codeTemplate = (tmpl as any).codeTemplate;
      if ((tmpl as any).developerBoilerplate) productData.developerBoilerplate = (tmpl as any).developerBoilerplate;
      if ((tmpl as any).workflowSystem) productData.workflowSystem = (tmpl as any).workflowSystem;
      if ((tmpl as any).automationGuide) productData.automationGuide = (tmpl as any).automationGuide;
      if ((tmpl as any).productivityFramework) productData.productivityFramework = (tmpl as any).productivityFramework;
      ...
      await Product.updateOne({ _id: productId }, { coverImageAssetId: imageAssets[0]._id });
